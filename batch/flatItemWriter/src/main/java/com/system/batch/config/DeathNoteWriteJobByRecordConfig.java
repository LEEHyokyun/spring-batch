...
//
//@Configuration
//public class DeathNoteWriteJobByRecordConfig {
//
//    @Bean
...
//    ) {
//        return new JobBuilder("deathNoteRecordWriteJob", jobRepository)
...
//                .fieldExtractor(recordFieldExtractor())
//                .headerCallback(writer -> writer.write("victimId,victimName"))
//                .build();
//    }
//
//    public static record DeathNote (
//        String victimId,
//        String victimName,
...
//    ){}
//
//    public RecordFieldExtractor recordFieldExtractor(){
//        RecordFieldExtractor<DeathNote> fieldExtractor = new RecordFieldExtractor<>(DeathNote.class);
//        fieldExtractor.setNames("victimId", "victimName");
