...
@Slf4j
@Configuration
public class FixedLengthSystemTerminationConfig {
    private final JobRepository jobRepository;
    private final PlatformTransactionManager transactionManager;

    public FixedLengthSystemTerminationConfig(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
    ...
    public FlatFileItemReader<SystemFailure> systemFailureItemReader(
        ...
        return new FlatFileItemReaderBuilder<SystemFailure>()
                ...
                .fixedLength()
                .columns(new Range[]{
                        new Range(1, 8),     // errorId: ERR001 + 2
                        new Range(9, 29),    // errorDateTime: 19 + 2
                        new Range(30, 38),   // severity: CRITICAL/FATAL + padding
                        new Range(39, 44),   // processId: 1234 + 2
                        new Range(45, 66)    // errorMessage: msg + \n
                })
